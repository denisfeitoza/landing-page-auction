...
const translations: Record<Language, Record<string, string>> = {
  'pt-BR': {
    ...
    'auctionLP.faq.a2': 'Trabalhamos com 6 grades: A+, LL+, B+, BC+, C+ e MIX. Cada grade tem padrões rigorosos de qualidade.',
    ...
    'auctionLP.faq.a5': 'Os lotes padrão são de 100 unidades por leilão.',
    ...
    // Auction LP - Lead Form
    'auctionLP.form.title': 'Solicitar Acesso',
    'auctionLP.form.subtitle': 'Preencha seus dados para receber acesso à plataforma de leilões.',
    'auctionLP.form.firstName': 'Nome',
    'auctionLP.form.firstNamePh': 'Seu nome',
    'auctionLP.form.lastName': 'Sobrenome',
    'auctionLP.form.lastNamePh': 'Seu sobrenome',
    'auctionLP.form.email': 'Email',
    'auctionLP.form.emailPh': 'seu@email.com',
    'auctionLP.form.phone': 'Telefone / WhatsApp',
    'auctionLP.form.phonePh': '(00) 00000-0000',
    'auctionLP.form.countries': 'Onde sua empresa opera?',
    'auctionLP.form.countriesPh': 'Selecione os países',
    'auctionLP.form.country.brazil': 'Brasil',
    'auctionLP.form.country.paraguay': 'Paraguai',
    'auctionLP.form.country.uae': 'Dubai / EAU',
    'auctionLP.form.country.usa': 'Estados Unidos',
    'auctionLP.form.country.europe': 'Europa',
    'auctionLP.form.country.other': 'Outro',
    'auctionLP.form.credentialsInfo': 'Após aprovação, você receberá seu login e senha por email e WhatsApp para acessar a plataforma de leilões.',
    'auctionLP.form.submit': 'Solicitar Acesso à Plataforma',
    'auctionLP.form.submitting': 'Enviando...',
    'auctionLP.form.required': 'Campo obrigatório',
    'auctionLP.form.invalidEmail': 'Email inválido',
    'auctionLP.form.error': 'Erro ao enviar. Tente novamente.',
    'auctionLP.form.successTitle': 'Solicitação Enviada!',
    'auctionLP.form.successDescription': 'Seus dados foram recebidos com sucesso. Nossa equipe irá analisar seu perfil e liberar seu acesso em breve.',
    'auctionLP.form.credEmail': 'Acesso por Email',
    'auctionLP.form.credEmailDesc': 'Você receberá seu login e senha diretamente no seu email.',
    'auctionLP.form.credWhatsApp': 'Acesso por WhatsApp',
    'auctionLP.form.credWhatsAppDesc': 'Também enviaremos seus dados de acesso pelo WhatsApp cadastrado.',
    'auctionLP.form.successClose': 'Entendido',
    'auctionLP.form.yourId': 'Seu ID de solicitação:',
    'auctionLP.form.whatsappCta': 'Solicitar Agora pelo WhatsApp',
    'auctionLP.form.whatsappMessage': 'Olá, solicitei meu acesso à plataforma de leilões! ID:',
  },
  'en': {
    // Navbar
    'nav.home': 'Home',
    ...
    'auctionLP.faq.a2': 'We work with 6 grades: A+, LL+, B+, BC+, C+, and MIX. Each grade has rigorous quality standards.',
    ...
    'auctionLP.faq.a5': 'Standard lots are 100 units per auction.',
    ...
    // Auction LP - Lead Form
    'auctionLP.form.title': 'Request Access',
    'auctionLP.form.subtitle': 'Fill in your details to receive access to the auction platform.',
    'auctionLP.form.firstName': 'First Name',
    'auctionLP.form.firstNamePh': 'First Name',
    'auctionLP.form.lastName': 'Last Name',
    'auctionLP.form.lastNamePh': 'Last Name',
    'auctionLP.form.email': 'Email Address',
    'auctionLP.form.emailPh': 'your@email.com',
    'auctionLP.form.phone': 'Phone / WhatsApp',
    'auctionLP.form.phonePh': 'Your phone number',
    'auctionLP.form.countries': 'Where does your company operate?',
    'auctionLP.form.countriesPh': 'Select countries',
    'auctionLP.form.country.brazil': 'Brazil',
    'auctionLP.form.country.paraguay': 'Paraguay',
    'auctionLP.form.country.uae': 'Dubai / UAE',
    'auctionLP.form.country.usa': 'United States',
    'auctionLP.form.country.europe': 'Europe',
    'auctionLP.form.country.other': 'Other',
    'auctionLP.form.credentialsInfo': 'After approval, you will receive your login and password via email and WhatsApp to access the auction platform.',
    'auctionLP.form.submit': 'Request Platform Access',
    'auctionLP.form.submitting': 'Submitting...',
    'auctionLP.form.required': 'Required field',
    'auctionLP.form.invalidEmail': 'Invalid email',
    'auctionLP.form.error': 'Error submitting. Please try again.',
    'auctionLP.form.successTitle': 'Request Submitted!',
    'auctionLP.form.successDescription': 'Your details have been received successfully. Our team will review your profile and grant access shortly.',
    'auctionLP.form.credEmail': 'Access via Email',
    'auctionLP.form.credEmailDesc': 'You will receive your login and password directly in your email.',
    'auctionLP.form.credWhatsApp': 'Access via WhatsApp',
    'auctionLP.form.credWhatsAppDesc': 'We will also send your access credentials via the registered WhatsApp.',
    'auctionLP.form.successClose': 'Got it',
    'auctionLP.form.yourId': 'Your request ID:',
    'auctionLP.form.whatsappCta': 'Request Now via WhatsApp',
    'auctionLP.form.whatsappMessage': 'Hello, I requested access to the auction platform! ID:',
  },
  'es': {
    // Navbar
    'nav.home': 'Inicio',
    ...
    'auctionLP.faq.a2': 'Trabajamos con 6 grados: A+, LL+, B+, BC+, C+ y MIX. Cada grado tiene estándares rigurosos de calidad.',
    ...
    'auctionLP.faq.a5': 'Los lotes estándar son de 100 unidades por subasta.',
    ...
    // Auction LP - Lead Form
    'auctionLP.form.title': 'Solicitar Acceso',
    'auctionLP.form.subtitle': 'Complete sus datos para recibir acceso a la plataforma de subastas.',
    'auctionLP.form.firstName': 'Nombre',
    'auctionLP.form.firstNamePh': 'Su nombre',
    'auctionLP.form.lastName': 'Apellido',
    'auctionLP.form.lastNamePh': 'Su apellido',
    'auctionLP.form.email': 'Correo Electrónico',
    'auctionLP.form.emailPh': 'su@email.com',
    'auctionLP.form.phone': 'Teléfono / WhatsApp',
    'auctionLP.form.phonePh': 'Su número de teléfono',
    'auctionLP.form.countries': '¿Dónde opera su empresa?',
    'auctionLP.form.countriesPh': 'Seleccione los países',
    'auctionLP.form.country.brazil': 'Brasil',
    'auctionLP.form.country.paraguay': 'Paraguay',
    'auctionLP.form.country.uae': 'Dubái / EAU',
    'auctionLP.form.country.usa': 'Estados Unidos',
    'auctionLP.form.country.europe': 'Europa',
    'auctionLP.form.country.other': 'Otro',
    'auctionLP.form.credentialsInfo': 'Después de la aprobación, recibirá su login y contraseña por correo electrónico y WhatsApp para acceder a la plataforma.',
    'auctionLP.form.submit': 'Solicitar Acceso a la Plataforma',
    'auctionLP.form.submitting': 'Enviando...',
    'auctionLP.form.required': 'Campo obligatorio',
    'auctionLP.form.invalidEmail': 'Correo inválido',
    'auctionLP.form.error': 'Error al enviar. Intente nuevamente.',
    'auctionLP.form.successTitle': '¡Solicitud Enviada!',
    'auctionLP.form.successDescription': 'Sus datos fueron recibidos con éxito. Nuestro equipo analizará su perfil y liberará su acceso en breve.',
    'auctionLP.form.credEmail': 'Acceso por Correo',
    'auctionLP.form.credEmailDesc': 'Recibirá su login y contraseña directamente en su correo electrónico.',
    'auctionLP.form.credWhatsApp': 'Acceso por WhatsApp',
    'auctionLP.form.credWhatsAppDesc': 'También enviaremos sus datos de acceso por el WhatsApp registrado.',
    'auctionLP.form.successClose': 'Entendido',
    'auctionLP.form.yourId': 'Su ID de solicitud:',
    'auctionLP.form.whatsappCta': 'Solicitar Ahora por WhatsApp',
    'auctionLP.form.whatsappMessage': 'Hola, solicité mi acceso a la plataforma de subastas! ID:',
  }
};
