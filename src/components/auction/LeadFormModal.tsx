                ...
                {isSuccess ? (
                  ...
                  >
                    ...
                    <a
                      ...
                      className="w-full flex items-center justify-center gap-2 bg-green-600 text-white px-6 py-3.5 rounded-xl font-bold text-sm hover:bg-green-500 transition-colors shadow-lg shadow-green-600/20 mb-3"
                    >
                    ...
                    <button
                      onClick={handleClose}
                      className="w-full bg-white/5 border border-white/10 text-white/60 px-6 py-3 rounded-xl font-medium text-sm hover:bg-white/10 hover:text-white transition-colors"
                    >
                      {t('auctionLP.form.successClose')}
                    </button>
                  </motion.div>
                ) : (
                  /* Form State */
